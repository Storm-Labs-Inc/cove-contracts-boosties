...
import { ISablierV2Batch, Batch, Broker, LockupLinear } from "src/interfaces/deps/sablier/ISablierV2Batch.sol";
...
contract SablierBatchCreator is CommonBase, Constants {
     ...
     * @param sender The address of the sender of the streams. This address will be the owner of the streams.
