...
contract Deployer20240802 is BaseDeployScript, CurveSwapParamsConstants {
    ...
    function deploy() public override {
        ...
        _deployCoveStrategy(
            deployer.getAddress("YearnStakingDelegate"), MAINNET_YVDAI_2_GAUGE, getMainnetYvdai2GaugeCurveSwapParams()
        );
        _deployCoveStrategy(
            deployer.getAddress("YearnStakingDelegate"), MAINNET_YVWETH_2_GAUGE, getMainnetYvweth2GaugeCurveSwapParams()
        );
        _deployCoveStrategy(
            deployer.getAddress("YearnStakingDelegate"),
            MAINNET_YVCRVUSD_2_GAUGE,
            getMainnetYvcrvusd2GaugeCurveSwapParams()
        );

        // TODO: execute these as multisig transactions
        // Deploy the cove gauges from admin address
        _deployCoveGauges(MAINNET_YVDAI_2_GAUGE);
        _deployCoveGauges(MAINNET_YVWETH_2_GAUGE);
        _deployCoveGauges(MAINNET_YVCRVUSD_2_GAUGE);
        // Set roles and deposit limit from timelock address
        // Limit deposit to max 100,000 USD
        _setRolesAndDepositLimit(MAINNET_YVDAI_2_GAUGE, 100_000e18);
        _setRolesAndDepositLimit(MAINNET_YVWETH_2_GAUGE, uint256(100_000e18 * 1e18) / 3100e18);
        _setRolesAndDepositLimit(MAINNET_YVCRVUSD_2_GAUGE, 100_000e18);
        // Approve tokens in the router
        address[] memory newYearnGauges = new address[](3);
        newYearnGauges[0] = MAINNET_YVDAI_2_GAUGE;
        newYearnGauges[1] = MAINNET_YVWETH_2_GAUGE;
        newYearnGauges[2] = MAINNET_YVCRVUSD_2_GAUGE;
