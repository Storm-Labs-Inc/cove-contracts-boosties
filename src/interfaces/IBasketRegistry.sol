...
interface IBasketRegistry {
     ...
     * @param baseAsset address of the base asset for the basket
     */
    function addRegistry(bytes32 registryName, address registryAddress, address baseAsset) external;
     ...
     * @param baseAsset address of the base asset for the basket
     */
    function updateRegistry(bytes32 registryName, address registryAddress, address baseAsset) external;
     ...
     * @return baseAsset address of the base asset for the basket
    ...
    /**
     * @notice Resolves a base asset to all baskets that use it.
     * @param baseAsset address of the base asset you want to resolve
     * @return address[] array of all baskets that use the given base asset
     */
